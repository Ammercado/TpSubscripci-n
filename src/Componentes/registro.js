          ...
          if(this.state.tipo ==='free'){
            ...
            return(
              <div>
                ...
                <CreditCardInput
                  cardNumberInputProps={{ onChange: this.handletarjetaNumberChange }}
                  cardExpiryInputProps={{ onChange: this.handletarjetaExpireChange }}
                  cardCVCInputProps={{ onChange: this.handletarjetaCvvChange }}
